        ...
        fields: {
            ...
            email: {
                validators: {
                    ...
                    emailAddress: {
                        message: 'El mail ingresado es un correo erroneo, ingresalo nuevamente'
                    }
                }
            },
            msg: {
                validators: {
                    notEmpty: {
                        message: 'El campo de mensaje es un campo requerido'
                    },
                    stringLength: {
                        max: 700,
            ...
            .on('success.form.fv', function (e) {
                ...
                $.post($form.attr('action'), $form.serialize(), function (result) {
                        ...
                        .done(function () {
                            ...
                            output.innerHTML = 'Tu mensaje ha sido enviado. Pronto nos pondremos en contacto contigo. ';
